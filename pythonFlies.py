...
# Write a program of  currency converter
...
# write a program to check if you  are elidgible or not  for vote
...
# wap to check the user eligible for job app
...
#Write a program to find which one is greater among three number
...
# write a program  to print their age using class and object 
